...
class TestAutoPE54TC01():
  ...
  def test_autoPE54TC01(self):
    self.driver.get("http://127.0.0.1:5000/")
    self.driver.set_window_size(1680, 1010)
    ...
    time.sleep(2)
    assert self.driver.find_element(By.CSS_SELECTOR, ".dropbtn").text == "Hello,\nSample"
